...
class App extends StatelessComponent {
  ...
  static List<StyleRule> get styles => [
        ...
        css('.theme-bridge').styles(
          ...
          border: .all(style: BorderStyle.solid, color: const Color('#c7d8ee'), width: 1.px),
          backgroundColor: const Color('#f7faff'),
        ),
        css('.theme-bridge-kicker').styles(
          textTransform: .upperCase,
          fontSize: 0.72.rem,
          fontWeight: .w700,
          letterSpacing: 0.08.em,
          color: const Color('#3d6f9f'),
          margin: .only(bottom: 6.px),
        ),
        css('.theme-bridge h2').styles(
          margin: .zero,
          color: const Color('#164f86'),
          fontSize: 1.4.rem,
        ),
        css('.theme-bridge p').styles(
          margin: .only(top: 8.px, bottom: .zero),
          color: const Color('#555566'),
          lineHeight: 1.55.em,
        ),
        css('.theme-bridge-code').styles(
          margin: .zero,
          minWidth: .zero,
          padding: .all(16.px),
          radius: .circular(8.px),
          overflow: .auto,
          backgroundColor: const Color('#102336'),
          color: const Color('#eaf3ff'),
          fontSize: 0.82.rem,
          lineHeight: 1.5.em,
        ),
