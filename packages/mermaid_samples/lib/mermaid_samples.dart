...
mindmap
  root((mermaid))
    ...
    Tools
      ...
      Mermaid
'''),
  Sample('mindmap-elk', 'Mindmap (ELK layout)', cCharts,
      'The same mindmap relaid out as a top-down hierarchical tree via '
          '`layout: elk` instead of the default radial spread.', '''
---
layout: elk
---
mindmap
