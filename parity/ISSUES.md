...
| P10 | mindmap | `layout: elk` relayouts in JS; ours ignores engine | layout-engine | 📝 | DOCUMENTED limitation: our mindmap is always a deterministic radial layout and does not re-lay-out under elk (upstream uses cose-bilkent/elk). Out of scope for now |
